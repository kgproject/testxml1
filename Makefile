#############################################################################
# Makefile for building: testxml
# Generated by qmake (2.01a) (Qt 4.8.5) on: Wed May 6 15:11:40 2015
# Project:  testxml.pro
# Template: app
# Command: /usr/local/Trolltech/Qt-4.8.5/bin/qmake -o Makefile testxml.pro
#############################################################################
...
Makefile: testxml.pro  /usr/local/Trolltech/Qt-4.8.5/mkspecs/linux-g++/qmake.conf /usr/local/Trolltech/Qt-4.8.5/mkspecs/common/unix.conf \
		/usr/local/Trolltech/Qt-4.8.5/mkspecs/common/linux.conf \
		/usr/local/Trolltech/Qt-4.8.5/mkspecs/common/gcc-base.conf \
		/usr/local/Trolltech/Qt-4.8.5/mkspecs/common/gcc-base-unix.conf \
		/usr/local/Trolltech/Qt-4.8.5/mkspecs/common/g++-base.conf \
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/testxml1.0.0 || $(MKDIR) .tmp/testxml1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/testxml1.0.0/ && $(COPY_FILE) --parents main.cpp .tmp/testxml1.0.0/ && (cd `dirname .tmp/testxml1.0.0` && $(TAR) testxml1.0.0.tar testxml1.0.0 && $(COMPRESS) testxml1.0.0.tar) && $(MOVE) `dirname .tmp/testxml1.0.0`/testxml1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/testxml1.0.0
